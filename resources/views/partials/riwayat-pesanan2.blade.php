                ...
                {{-- <div class="card-body"> --}}
                    {{-- <div class="tab-content" id="myTabContent"> --}}
                        <div class="tab-pane fade show active" id="biodata" role="tabpanel" aria-labelledby="biodata-tab">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-details">
                                            ...
                                            <div class="content">
                                                <span class="highlight">Jumlah Kuli 10 orang</span>
                                                <span class="highlight">Serba Bisa, Whatsapp</span>
                                            </div>
                                            <div class="content">
                                                <p><b>Status</b></p>
                                                <span class="status status-pending">Menungu Penilaian</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section class="profile-review mt-3">
                                <div class="review-card">
                                    <div class="review-profile">
                                        <img src="img/profil/Frame 2.png" class="rounded-circle" alt="Profile Picture">
                                    </div>
                                    <div class="review-content">
                                        <p class="add-review-text">Tambahkan Ulasan...</p>
                                    </div>
                                    <div class="review-edit-icon">
