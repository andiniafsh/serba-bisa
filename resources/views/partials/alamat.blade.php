                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="alamat-tab"  href="/alamat" role="tab"
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="alamat" role="tabpanel"
                            ...
                            <div class="mt-3">
                                <h6>Alamat Saya<a href="#" class="text-green" style="color: #039855; text-decoration: none;" >Ubah<i class="fas fa-pencil-alt"></i></a></h6>
                                <div class="address-card">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <p>M. Wahyu Dimas A.</p>
                                            <p>087766994762</p>
                                            <p>JL Mawar Melati No. 23 Desa Tambak Sawah, Rt 007 Rw 002, WARU, SIDOARJO,
                                                JAWA TIMUR, ID 61256</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="status">Utama</p>
                                            <p class="edit-link">Ubah</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="address-card">
