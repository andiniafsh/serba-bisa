            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="biodata-tab"  href="/biodata" role="tab"
                                aria-controls="biodata" aria-selected="false">Biodata Diri</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="keamanan-tab"  href="/pengaturan"
                                role="tab" aria-controls="keamanan" aria-selected="true">Keamanan</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <!-- Keamanan Section -->

                        <div class="tab-pane fade show active" id="keamanan" role="tabpanel"
                            aria-labelledby="keamanan-tab">
                            <div class="row mt-3">
                                <div class="col-md-4 text-center custom-border">
                                    <h1>Hai Poyeski!</h1>
                                    <h4>Atur Keamanan Anda Disini</h4>
                                    <div class="mt-3">
                                        <p>Aktivitas Login</p>
                                    </div>
                                    <div class="mt-3">
